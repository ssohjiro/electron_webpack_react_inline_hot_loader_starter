...
RIX_OPTIONS = --relativize --ignore-dependencies --ignore-node-core --cache-dir $(RIX_CACHE_DIR)
...
rixwatch: _install
	$(BIN)/react-inline-extract $(RIX_OPTIONS) --watch src/rendererProcess/component/ src/rendererProcess/_afterRixComponent/
